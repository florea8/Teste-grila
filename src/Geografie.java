...
public class Geografie implements ActionListener{
	
	String[] questions = 	{
			"1.Care este resedinta de judet din Salaj?",
			"2.In ce Judet se afla cascada Duruitoarea?",
			"3.Care este judetul cu cei mai multi locuitori din Romania(exludem Bucuresti)",
			"4.Care este suprafata cursului Dunarii pe teritoriul Romaniei?",
			"5.Care este cea mai mare comuna din Romania, dupa numarul de locuitori?",
			"6.Cate varfuri peste 2500 de metri exista in Romania?",
			"7.La marginea carei localitator din judetul Bihor se afla Pestera Ursilor?",
			"8.Care este cel mai inalt varf din Muntii Macin?",
			"9.Care este cel mai aglomerat aeroport din lume?",
			"10.In ce comitat este Castelul Leeds?",
			"11.Ce este La Palma?"
		};
String[][] options = 	{
			{"Salonta","Oradea","Zalau","Timis"},
			{"Neamt","Bihor","Cluj","Olt"},
			{"Prahova","Timis","Iasi","Constanta"},
			{"1025","1050","1075","1100"},
			{"Prahova", "Vaslui", "Mehedinti","Timis"},
			{"8","12","14","6"},
			{"Floresti","Chiajna","Bradesti","Fierbinti"},
			{"Pietroasa","Chiscau","Stei","Bihor"},
			{"Tutuianu","Megina","Babadag","Moldoveanu"},
			{"London Heathrow","Beijing Capital International","Hartsfield-Jackson","Dubai International"},
			{"Shorpsire","Berkshire","Yorkshire","Kent"},
			{"Un oras din Italia","O insula","O capitala","O provincie spaniola"}
...
char[] answers = 		{
	...
	public Geografie() {
		...
		number_right.setBackground(new Color(26,26,26));
		number_right.setForeground(new Color(26,255,0));
