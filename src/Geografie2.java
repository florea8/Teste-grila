...
public class Geografie2 implements ActionListener{
	
	String[] questions = 	{
			"1.Care este cel mai lung fluviu din Europa?",
			"2.Ce tara din America de Sud are cea mai mare suprafata?",
			"3.Care este cel mai estic oras al Romaniei?",
			"4.Din ce tara izvoraste Dunarea?",
			"5.Care este capitala Suediei?",
			"6.Care este cel mai mare munte de pe Glob?",
			"7.Care este cel mai lung rau din lume?",
			"8.Care este cea mai mica tara din lume?",
			"9.In ce oras se afla Casa Alba din S.U.A?",
			"10.Care este cea mai mare insula din lume?",
			"11.Care este capitala Scotiei?"
		};
String[][] options = 	{
			{"Dunarea","Volga","Tamisa","Sena"},
			{"Brazilia","Argentina","Chile","Uruguay"},
			{"Sulina","Brasov","Bucuresti","Timisoara"},
			{"Polonia","Germania","Elvetia","Repuplica Ceha"},
			{"Stockholm","Oslo","Helsinki","Riga"},
			{"Alpi", "Everest", "Carpati","Lhotse"},
			{"Amazon","Nil","Volga","Mississippi"},
			{"Monaco","San Marino","Vatican","Romania"},
			{"Washington D.C","New York","Los Angeles","Las Vegas"},
			{"Hawaii","Madagascar","Sicilia","Groenlanda"},
			{"Dublin","Londra","Edinburgh","Madrid"}
...
char[] answers = 		{
	...
	public void results(){
		...
		textfield.setText("Rezultatul testului:");
		textarea.setText("");
