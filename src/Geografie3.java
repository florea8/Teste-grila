...
public class Geografie3 implements ActionListener{
	
	String[] questions = 	{
			"1.Care este capitala statului statului Chile?",
			"2.Care este cea mai mare cascada din lume?",
			"3.Pe ce continent se gaseste desertul Gobi?",
			"4.Care tara mai este numita si Tara soarelui rasare?",
			"5.Ce rau strabate capitala Frantei, Paris?",
			"6.Care este cel mai mic ocean din lume?",
			"7.Care este capitala Tailandei?",
			"8.De ce ocean este inconjurat Madagascar?",
			"9.Care este numele faimosului parc din New York?",
			"10.Care este capitala Croatiei?",

		};
String[][] options = 	{
			{"Buenos Aires","Rosario","Rio de Janeiro","Santiago"},
			{"Niagara","Angels","Victoria","Iguazu"},
			{"Europa","Africa","Asia","Australia"},
			{"Japonia","China","Franta","Austria"},
			{"Moldou","Neva","Sena","Dunarea"},
			{"Arctic", "Atlantic", "Indian","Caraibelor"},
			{"Bangkok","Ulan Batar","Beijing","New Delhi"},
			{"Atlantic","Indian","Artic","Pacific"},
			{"New York Park","Arches","Central Park","Acadia"},
			{"Hamburg","Belgrad","Bratislava","Zagreb"}
