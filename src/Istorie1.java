...
public class Istorie1 implements ActionListener{
	
	String[] questions = 	{
			"1.Ce domnitor este inmormantat la Manastirea Cozia?",
			"2.Cleopatra a fost de origine?",
			"3.In ce an a avut loc Marea Unire?",
			"4.Mihai Viteazul a fost domnitorul carei tari?",
			"5.In ce an s-a nascut Alexandru Ioan Cuza?",
			"6.In ce an a murit Mircea cel Batran?",
			"7.In ce an a intrat Romania in Primul Razboi Mondial?",
			"8.Cine a fost primul premier al Romaniei dupa caderea regimului comunist?",
			"9.Cine a fost primul prim-ministru din istoria Romaniei?",
			"10.In ce an a avut loc revolutia lui Tudor Vladimirescu?"
		};
String[][] options = 	{
			{"Mircea cel Batran","Alexandru Ioan Cuza","Mihai Viteazul","Vlad Tepes"},
			{"Greaca","Franceza","Romana","Egipteana"},
			{"1918","1910","1900","1989"},
			{"Transilvania","Bulgaria","Tara Romaneasca","Moldova"},
			{"1820","1800","1850","1795"},
			{"1420", "1418", "1500","1550"},
			{"1910","1920","1916","1918"},
			{"Ion Iliescu","Traian Basescu","Petre Roman","Victor Ponta"},
			{"Mihail Kogalniceanu","Barbu Catargiu","Apostol Arsache","Tudor Vladimirescu"},
			{"1800","1700","1900","1821"}
